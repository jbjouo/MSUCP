...
export const LINK_SKILLS = {
  ...
  combo_kill_blessing: {
    ...
    icon: '/skills/link/combo_kill_blessing.png',
    owners: ['aran'],
    classGroup: 'heroes',
    uniqueByJob: true,
    specialEffect: true,
  ...
  rune_persistence: {
    ...
    icon: '/skills/link/rune_persistence.png',
    owners: ['evan'],
    classGroup: 'heroes',
    uniqueByJob: true,
    specialEffect: true,
  ...
  elven_blessing: {
    ...
    icon: '/skills/link/elven_blessing.png',
    owners: ['mercedes'],
    classGroup: 'heroes',
    uniqueByJob: true,
    specialEffect: true,
  ...
  phantom_instinct: {
    ...
    icon: '/skills/link/phantom_instinct.png',
    owners: ['phantom'],
    classGroup: 'heroes',
    uniqueByJob: true,
    specialEffect: false,
  ...
  light_wash: {
    ...
    icon: '/skills/link/light_wash.png',
    owners: ['luminous'],
    classGroup: 'heroes',
    uniqueByJob: true,
    specialEffect: false,
  ...
  close_call: {
    ...
    icon: '/skills/link/close_call.png',
    owners: ['shade'],
    classGroup: 'heroes',
    uniqueByJob: true,
    specialEffect: true,
  ...
  knights_watch: {
    ...
    icon: '/skills/link/knights_watch.png',
    owners: ['mihile'],
    classGroup: 'mihile',
    uniqueByJob: true,
    specialEffect: true,
  ...
  cygnus_blessing: {
    ...
    icon: '/skills/link/cygnus_blessing.png',
  ...
  invincible_belief: {
    ...
    icon: '/skills/link/invincible_belief.png',
  ...
  adventurers_curiosity: {
    ...
    icon: '/skills/link/adventurers_curiosity.png',
  ...
  pirate_blessing: {
    ...
    icon: '/skills/link/pirate_blessing.png',
  ...
  thiefs_cunning: {
    ...
    icon: '/skills/link/thiefs_cunning.png',
  ...
  empirical_knowledge: {
    ...
    icon: '/skills/link/empirical_knowledge.png',
