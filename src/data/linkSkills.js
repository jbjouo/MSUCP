...
export const LINK_SKILLS = {
  ...
  cygnus_blessing: {
    ...
    maxTotalLevel: 10,
    levels: [
      { level: 1,  descKey: 'linkSkill.skills.cygnus_blessing.desc.1',  stats: { atk: 7,  matk: 7,  } },
      { level: 2,  descKey: 'linkSkill.skills.cygnus_blessing.desc.2',  stats: { atk: 9,  matk: 9,  } },
      { level: 3,  descKey: 'linkSkill.skills.cygnus_blessing.desc.3',  stats: { atk: 11, matk: 11, } },
      { level: 4,  descKey: 'linkSkill.skills.cygnus_blessing.desc.4',  stats: { atk: 13, matk: 13, } },
      { level: 5,  descKey: 'linkSkill.skills.cygnus_blessing.desc.5',  stats: { atk: 15, matk: 15, } },
      { level: 6,  descKey: 'linkSkill.skills.cygnus_blessing.desc.6',  stats: { atk: 17, matk: 17, } },
      { level: 7,  descKey: 'linkSkill.skills.cygnus_blessing.desc.7',  stats: { atk: 19, matk: 19, } },
      { level: 8,  descKey: 'linkSkill.skills.cygnus_blessing.desc.8',  stats: { atk: 21, matk: 21, } },
      { level: 9,  descKey: 'linkSkill.skills.cygnus_blessing.desc.9',  stats: { atk: 23, matk: 23, } },
      { level: 10, descKey: 'linkSkill.skills.cygnus_blessing.desc.10', stats: { atk: 25, matk: 25, } },
    ],
  },
  invincible_belief: {
