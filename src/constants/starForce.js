...
//   1-5★   +2 主&副屬
//   6-15★  +3 主&副屬
//   16★ 起 武器 全含 +15 全屬 (rangeTo 22;23★ 不疊全屬,僅 ATT 特例)
//   武器 16-22★ ATT:16:+13 17:+13 18:+14 19:+14 20:+15 21:+16 22:+17
//   武器 23★ 特例 +34 ATT
//   防具 / 手套 / 飾品 16+ 規則尚未提供 → 沿用 Lv160 數值(+13 全屬 / 主&副 + Lv160 attByStar)
const TABLE_200 = {
  mainSubByStar: [
    { from: 1, to: 5,  delta: 2 },
    { from: 6, to: 15, delta: 3 },
  ...
  perStarFrom16: {
    weapon: { allStat: 15, rangeTo: 22 },
    armor:  { mainSub: 13, rangeTo: 22 }, // 暫用 Lv160 數值
    glove:  { mainSub: 13, rangeTo: 22 }, // 暫用 Lv160 數值
    other:  { allStat: 13, rangeTo: 22 }, // 暫用 Lv160 數值
  },
  attByStar: {
    weapon: {
      16: 13, 17: 13, 18: 14, 19: 14, 20: 15, 21: 16, 22: 17,
      23: 34,
    },
    armor: { // 暫用 Lv160 數值
      16: 10, 17: 11, 18: 12, 19: 13, 20: 14, 21: 15, 22: 17,
