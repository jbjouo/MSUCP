...
//   1-5★   +2 主&副屬
//   6-15★  +3 主&副屬
//   16★ 起 武器 +15 全屬 / 防具 +15 主&副 / 手套 +15 主&副 / 飾品 +15 全屬 (rangeTo 22)
//   武器 16-22★ ATT:13/13/14/14/15/16/17  23★ 特例 +34
//   防具 / 手套 / 飾品 16-22★ ATT:12/13/14/15/16/17/19  23★ +21
const TABLE_200 = {
  mainSubByStar: [
    { from: 1, to: 5,  delta: 2 },
    { from: 6, to: 15, delta: 3 },
  ...
  perStarFrom16: {
    ...
    armor:  { mainSub: 15, rangeTo: 22 },
    glove:  { mainSub: 15, rangeTo: 22 },
    other:  { allStat: 15, rangeTo: 22 },
  },
  attByStar: {
    weapon: {
    ...
    armor: {
      16: 12, 17: 13, 18: 14, 19: 15, 20: 16, 21: 17, 22: 19,
      23: 21,
    },
    glove: {
      5: 1, 7: 1, 9: 1, 11: 1, 13: 1, 14: 1, 15: 1,
